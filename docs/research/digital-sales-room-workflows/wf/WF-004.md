...
- [x] Technical design doc written and Jev-validated
- [x] Implemented
- [x] Tests written and passing
- [ ] Reviewer bot passed
- [ ] Jev merge gate passed
- [x] Verified in localhost browser

Implementation notes, the sourced/inferred split, and the recorded decisions are
in [`docs/wf-004.md`](../../../wf-004.md).
